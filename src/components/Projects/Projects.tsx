            ...
            <motion.div className={styles['project-grid']} variants={animations.staggerContainer} initial="initial" whileInView="animate" viewport={{ once: true }}>
                <motion.a href="https://github.com/Kristian-dev4/Meme-Maker" target="_blank" style={{ textDecoration: "none" }}>
                    <motion.div className={styles['project-card']} whileHover={{ y: -10, transition: { duration: 0.2 } }}
                        ...
                        <motion.div className={styles['project-image']} style={{ backgroundImage: "url(/projects/meme_maker.png)" }}
                ...
                <motion.a href="https://github.com/Kristian-dev4/Lutenitsa-Appraiser" target="_blank" style={{ textDecoration: "none" }}>
                    <motion.div className={styles['project-card']} whileHover={{ y: -10, transition: { duration: 0.2 } }}
                        ...
                        <motion.div className={styles['project-image']} style={{ backgroundImage: "url(/projects/lutenitsa_appraiser.png)" }}
                            whileHover={{ scale: 1.05, transition: { duration: 0.2 } }} />
