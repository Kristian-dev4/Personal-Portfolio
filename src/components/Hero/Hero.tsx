...
export const Hero = () => {
    return (
        <motion.section id="home" className={styles['hero']} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.2 }}>
            <div className={styles['hero-container']}>
                <motion.div className={styles['hero-content']} variants={animations.staggerContainer} initial="initial" animate="animate">
                    ...
                    <motion.div className={styles['cta-buttons']} variants={animations.staggerContainer}>
                    ...
                    <motion.div className={styles['social-links']} variants={animations.staggerContainer} >
                ...
                <motion.div className={styles['hero-image-container']}
  ...
  availability: "Available for hire",
                    ...
                    <motion.div className={styles['floating-card']}
